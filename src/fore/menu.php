...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg fixed-top bg-putih">
    ...
    <section id="menu-banner">
        <div class="container">
            <img src="images/menu-bg.png" class="bg-menu" alt="background menu">
            <img src="images/our-menu.png" class="our-menu" alt="our menu">
            <h1>MENU</h1>
        </div>
    </section>

    <section id="menu-daftar">
        ...
        <div class="row list-menu">
            <div class="col-lg-4 position-relative">
                <div class="side-menu">
                    <a href="">Americano Series</a>
                    <a href="">Coffee</a>
                    <a href="">Coffee of The Day</a>
                    <a href="">Hakken 1L</a>
                    <a href="">Signature</a>
                    <a href="">Non Coffee</a>
                </div>
            ...
            <div class="col-lg-8">
                <div class="group">
                    <h2>Americano Series</h2>
                    <div class="row">
                        <div class="col-lg-6 item-menu">
                            <div class="row">
                                <div class="col-lg-6">
                                    <img src="images/produk1.jpg" alt="produk">
                                </div>
                                <div class="col-lg-6">
                                    <div class="text">
                                        <h3>Iced Americano</h3>
                                        <h4><span>Rp</span>21.000</h4>
