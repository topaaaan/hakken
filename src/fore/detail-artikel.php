...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg fixed-top bg-putih">
    ...
    <section id="detail-artikel">
        <div class="container">
            <img class="banner" src="images/artikel1.jpg" alt="banner artikel">
            <p class="kategori">Uncategorized</p>
            <p class="tanggal">Januari 30, 2025</p>
            <h1 class="judul">[Press Release] Fore Coffee Pimpin Pasar Kopi dengan Inovasi dan Konsistensi Produk Premium yang Terjangkau</h1>
            <div class="isi-artikel">
                <p>Jakarta, 22 Januari 2025 – Fore Coffee, perusahaan F&B coffee chain premium affordable terkemuka di Indonesia, berkomitmen untuk terus berinovasi mengembangkan bisnis secara berkelanjutan, agar pertumbuhan perusahaan semakin kuat dan kompetitif, terutama dalam memimpin tren pasar yang dinamis, serta hadir memenuhi kebutuhan pelanggan melalui produk premium terjangkau.</p>
                <p>Selama hampir tujuh tahun, Fore Coffee telah menjadi bagian dari budaya kopi masyarakat Indonesia, dan berhasil berkembang pesat dengan membuka 217 gerai yang sukses, tersebar di 43 kota di Indonesia dan Singapura per September 2024. Pertumbuhan signifikan ini diperkuat dengan pembukaan 61 gerai baru sepanjang 2024, menandai pertumbuhan outlet terbanyak secara year on year (YoY) Fore Coffee. </p>
                <p>Pencapaian ini merupakan hasil pemahaman mendalam tim riset dan pengembangan (R&D), yang solid dalam mengembangkan beragam produk inovatif, menyesuaikan kebutuhan pelanggan dengan target pasar premium affordable.</p>
                <p>Riset pasar secara mendalam adalah pijakan penting bagi Fore Coffee dalam menyusun strategi yang tepat sasaran. Strategi ini berawal dari studi lapangan dengan membandingkan produk sejenis di pasar regional dan global sebagai acuan kinerja pertumbuhan.</p>
            </div>
        </div>
    </section>
